...
Digital Phosphor Oscilloscopes - TDS3054 (4-channel, 500MHz) and TDS3012B (2-channel, 100MHz).

## Import

```python
from gtape_prologix_drivers.instruments.tds3000 import TDS3054, TDS3012B, WaveformData
```
...
|-----------|------|-------------|
| `channel` | str | Channel name ("CH1", "CH2", etc.) |
| `record_length` | int \| None | Override record length (skips query if provided) |
